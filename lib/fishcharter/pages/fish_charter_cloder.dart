...
class FIshCatcherCloseOrderScreen extends StatefulWidget {
  const FIshCatcherCloseOrderScreen({super.key});

  @override
  State<FIshCatcherCloseOrderScreen> createState() =>
      _FIshCatcherCloseOrderScreenState();
}

class _FIshCatcherCloseOrderScreenState
    extends State<FIshCatcherCloseOrderScreen> {
  @override
                                ...
                                InkWell(
                                  onTap: () {
                                    Navigator.popAndPushNamed(context,
                                        MyRouters.fishCharterHistoryScreen);
                                  },
                                  child: Container(
                                    height: 40,
                                    width: 150,
