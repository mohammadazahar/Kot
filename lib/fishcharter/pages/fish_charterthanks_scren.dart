...
class FishCharterThanksScreen extends StatelessWidget {
  FishCharterThanksScreen({Key? key})
      : super(
          key: key,
        );
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  "Fish Charter Booking Sucess Fully",
                  maxLines: 3,
                  overflow: TextOverflow.ellipsis,
                  textAlign: TextAlign.left,
              ...
              CustomElevatedButton(
                onTap: () {
                  Navigator.pushNamed(
                      context, MyRouters.fishCharterHistoryScreen);
                },
                text: "Fish Charter History",
                margin: getMargin(
                  left: 20,
                  right: 21,
                ),
