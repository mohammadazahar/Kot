...
class ThanksScreenTournament extends StatelessWidget {
  ThanksScreenTournament({Key? key})
      : super(
          key: key,
        );
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  "Thank you for Joining the Event  Will send you,The Event Details Through Your Mail Id",
                  maxLines: 3,
                  overflow: TextOverflow.ellipsis,
                  textAlign: TextAlign.left,
              ...
              CustomElevatedButton(
                onTap: () {
                  Navigator.pushNamed(
                      context, MyRouters.myTournamentHistoryScreen);
                },
                text: "Go to Tournments",
                margin: getMargin(
                  left: 20,
                  right: 21,
                ),
